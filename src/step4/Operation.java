...
public class Operation {
	 ...
	 */
	public Operation(String opCode, Symbol operand1, Symbol operand2, Symbol result) {
	 ...
	 */
	public Operation(String opCode, Symbol operand1, Symbol operand2, String label) {
	 ...
	 */
	public Operation(String opCode, String label) {
	 ...
	 */
	public Operation(String opCode, Symbol result) {
		this(opCode, null, null, result, null);
	}

	private Operation(String opCode, Symbol operand1, Symbol operand2, Symbol result, String label) {
		this.opCode = opCode;

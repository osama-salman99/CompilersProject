...
public class MicroParser extends Parser {
	...
	public static class ElseContext extends Else_partContext {
		...
		public ElseContext(Else_partContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class No_elseContext extends Else_partContext {
		public No_elseContext(Else_partContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class PrimaryParenthesesContext extends PrimaryContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MicroVisitor ) return ((MicroVisitor<? extends T>)visitor).visitPrimaryParentheses(this);
			else return visitor.visitChildren(this);
		}
	}

...
public class MicroParser extends Parser {
	...
	public final CondContext cond() throws RecognitionException {
		...
		try {
			...
			{
				setState(225);
				((CondContext) _localctx).firstExpr = expr();
				setState(226);
				compare();
				setState(227);
				((CondContext) _localctx).secondExpr = expr();
			}
		} catch (RecognitionException re) {
			_localctx.exception = re;
			_errHandler.reportError(this, re);
	...
	public static class IdContext extends ParserRuleContext {
		...
		public TerminalNode IDENTIFIER() {
			return getToken(MicroParser.IDENTIFIER, 0);
		}
	...
	public static class StrContext extends ParserRuleContext {
		...
		public TerminalNode STRINGLITERAL() {
			return getToken(MicroParser.STRINGLITERAL, 0);
		}
	...
	public static class Param_decl_listContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof MicroVisitor)
				return ((MicroVisitor<? extends T>) visitor).visitParam_decl_list(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Param_decl_tailContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof MicroVisitor)
				return ((MicroVisitor<? extends T>) visitor).visitParam_decl_tail(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Func_declarationsContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof MicroVisitor)
				return ((MicroVisitor<? extends T>) visitor).visitFunc_declarations(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FloatliteralContext extends PrimaryContext {
		public FloatliteralContext(PrimaryContext ctx) {
			copyFrom(ctx);
		}
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof MicroVisitor) return ((MicroVisitor<? extends T>) visitor).visitFloatliteral(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class PrimaryParenthesesContext extends PrimaryContext {
		public PrimaryParenthesesContext(PrimaryContext ctx) {
			copyFrom(ctx);
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof MicroVisitor)
				return ((MicroVisitor<? extends T>) visitor).visitPrimaryParentheses(this);
			else return visitor.visitChildren(this);
		}
	}

	public static class IntliteralContext extends PrimaryContext {
		public IntliteralContext(PrimaryContext ctx) {
			copyFrom(ctx);
		}

		public TerminalNode INTLITERAL() {
			return getToken(MicroParser.INTLITERAL, 0);
		}

		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof MicroVisitor) return ((MicroVisitor<? extends T>) visitor).visitIntliteral(this);
			else return visitor.visitChildren(this);
		}
	}

...
public interface MicroVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitPrimaryParentheses(MicroParser.PrimaryParenthesesContext ctx);
	 ...
	 * @return the visitor result
	 */
	T visitIntliteral(MicroParser.IntliteralContext ctx);
	 ...
	 * @return the visitor result
	 */
	T visitFloatliteral(MicroParser.FloatliteralContext ctx);
